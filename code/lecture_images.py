...
def clear_image(image, image_shape):
    ...
    :return: modified image based on the image shape
    """
...
def show_image(number_of_images, *args):
    ...
    :param number_of_images: number of images want to display
    :param args: images which are wanted to be display
    """
...
if __name__ == '__main__':
    ...
    assert items, 'items in the target directory are not accessible '
    for item in items:
        try:
